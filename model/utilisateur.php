...
class Utilisateur extends Model{
    ...
    public static function ajouteQuizz($id_utilisateur){
        $sql = "INSERT INTO `quiz` (`titreQuiz`, `dateCreation`, `visibilite`, `image`, `couleur`, `codesecret`, `type_id`, `id_Utilisateur`) VALUES ('NouveauQuiz', :Date, '0', '', '#F8B4FC',  NULL, '1', :id_utilisateur)";
        $req = Connexion::pdo()->prepare($sql);
