<div id="containerStartQuiz">
    ...
    <div id="menuBtnStartQuiz">
        <button class="btnEndQuiz" id="scoreBtnEndQuiz">Mes Scores <i class="bi bi-award-fill"></i></button>
        <button class="btnEndQuiz" id="exitBtnEndQuiz">Quitter <i class="bi bi-x-circle"></i></button>
    </div>
</div>

<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
<script src="./js/endQuiz.js"></script>