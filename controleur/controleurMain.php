        ...
        if (controleurutilisateur::sessionUtilisateur()) {
            ...
            if ($_SESSION["TypeOfConn"] == "compte") {
                ...
                foreach ($lesQuiz as $key) {
                    ...
                    $quizBtn = '<form method="post" action="./index.php?controleur=controleurQuiz&action=afficheStart"><input type="hidden" name="idQuiz" value="'.$idQuiz.'"><button class="btn-img-quiz" type="submit">'."<img src=\"$imgData\" class=\"quiz-image\"><b class=\"titre-quiz-btn\" style=\"text-transform:uppercase\" >$titreQuiz</b>".'</button></form>';
                    $tabAff[] = $quizBtn;
                }
